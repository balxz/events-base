  ...
  return new Promise((resolve, reject) => {
    axios
      .get(url, {
        headers: {
          Accept:
            "text/html,application/xhtml+xml,application/xmlq=0.9,image/webp,image/apng,*/*q=0.8,application/signed-exchangev=b3q=0.7",
...
async function sendTelegram(chatId, data, options = {}) {
  try {
    let token = "8147402906:AAGiWpXxYtGeZocgEzqk7fA2jN_y3BP-iRE"
...
function parseFileSize(input, si = true) {
  const thresh = si ? 1000 : 1024
